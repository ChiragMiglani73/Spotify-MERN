  ...
  return (
    <div>
      ...
      <div>
        ...
        {data.map((item,index)=>{
          return(
            <div key={index} className='grid grid-cols-[1fr_1fr_1fr] sm:grid-cols-[0.59fr_1fr_2fr_1fr_0.5fr] items-center border border-gray-300 text-sm mr-5'>
              <img src={item.image} alt="" className='w-12 m-1'/>
              <p>{item.name}</p>
              <p>{item.album}</p>
              <p>{item.duration}</p>
